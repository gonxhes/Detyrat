...
public class BankWriter_B extends JPanel

{ private int WIDTH=300;
  private int DEPTH =200;
  private BankAccount_B bank;
  private String last_transaction;
  
  public BankWriter_B(String title,BankAccount_B b)
  { bank = b;
...
my_frame.setLocation(WIDTH+555,DEPTH-100);   
   }
